        ...
        {selectedTable ? (
          <div className="db-table-view">
            <div className="db-table-header">
              ...
              <button className="db-refresh-btn" onClick={onRefreshTable} disabled={loadingTable}>
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
          ...
          <div className="db-no-selection">
            ...
            <span className="db-no-selection-title">
              Select a {dbType === "mongodb" ? "collection" : "table"}
            </span>
